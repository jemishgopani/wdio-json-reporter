...
class JsonXrayReporter extends WDIOReporter {
    constructor(options) {
        ...
        for (let specId of Object.keys(runner.specs)) {
            ...
            for (let suiteKey of Object.keys(this.suites)) {
                ...
                for (let testName of Object.keys(suite.tests)) {
                    ...
                    testCase.testKey = runner.specs[specId]
                        .split("\\")[3]
                        .split(".")[0];
...
exports.default = JsonXrayReporter;
exports.default.name = "json-xray-reporter";
